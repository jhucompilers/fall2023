...
**Due**: Friday, Sep 15th by 11pm Baltimore time
...
```
wget https://jhucompilers.github.io/fall2023/assign/assign01.zip
unzip assign01.zip
```
...
```
git clone https://github.com/jhucompilers/fall2023-tests.git compilers-fall2023-tests
```
